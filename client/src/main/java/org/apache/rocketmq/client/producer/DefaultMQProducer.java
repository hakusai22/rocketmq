...
public class DefaultMQProducer extends ClientConfig implements MQProducer {
  ...
  /**
   * 同步模式发送消息。此方法只有在发送过程完全完成后才会返回。 </p>
   *
   * <strong>警告：</strong> 此方法具有内部重试机制，即内部实现将在声明失败之前重试
   * {@link #retryTimesWhenSendFailed} 次。因此，可能会有多个消息被传递给代理。解决潜在的重复问题取决于应用程序开发人员。
   *
   * @param msg 要发送的消息。
   * @return 返回一个 {@link SendResult} 实例，告知发送者消息的详细信息，例如消息ID、
   * {@link SendStatus} 表示代理存储/复制状态、发送的消息队列等。
  ...
  public void sendOneway(
      Message msg) throws MQClientException, RemotingException, InterruptedException {
    msg.setTopic(withNamespace(msg.getTopic()));
  ...
  public Message request(final Message msg,
      final long timeout) throws RequestTimeoutException, MQClientException,
   ...
   */
  @Override
  public void request(final Message msg, final RequestCallback requestCallback,
      final long timeout)
   ...
   */
  @Override
  public Message request(final Message msg, final MessageQueueSelector selector,
      final Object arg,
   ...
   */
  @Override
  public void request(final Message msg, final MessageQueueSelector selector,
      final Object arg,
   ...
   */
  public void setAsyncSenderExecutor(
      final ExecutorService asyncSenderExecutor) {
  ...
  private MessageBatch batch(
      Collection<Message> msgs) throws MQClientException {
  ...
  public void setSendMessageWithVIPChannel(
      final boolean sendMessageWithVIPChannel) {
  ...
  public void setRetryTimesWhenSendAsyncFailed(
      final int retryTimesWhenSendAsyncFailed) {
  ...
  public void setEnableBackpressureForAsyncMode(
      boolean enableBackpressureForAsyncMode) {
   ...
   */
  public void setBackPressureForAsyncSendSize(
   ...
   */
  public void setBackPressureForAsyncSendSizeInsideAdjust(
      int backPressureForAsyncSendSize) {
    this.backPressureForAsyncSendSize = backPressureForAsyncSendSize;
  }
  ...
  public void setBackPressureForAsyncSendNumInsideAdjust(
      int backPressureForAsyncSendNum) {
    this.backPressureForAsyncSendNum = backPressureForAsyncSendNum;
  }
