...
public class MQClientAPIImpl implements NameServerUpdateCallback, StartAndShutdown {
  ...
  public void createSubscriptionGroup(final String addr,
  ...
  public void createSubscriptionGroupList(final String address,
      final List<SubscriptionGroupConfig> configs,
      final long timeoutMillis) throws RemotingException, InterruptedException, MQClientException {
  ...
  public void createTopicList(final String address,
      final List<TopicConfig> topicConfigList, final long timeoutMillis)
  ...
  public void createPlainAccessConfig(final String addr,
  ...
  public void deleteAccessConfig(final String addr, final String accessKey,
      final long timeoutMillis)
      throws RemotingException, InterruptedException, MQClientException {
  ...
  public void updateGlobalWhiteAddrsConfig(final String addr,
      final String globalWhiteAddrs, String aclFileFullPath,
      final long timeoutMillis)
      throws RemotingException, MQBrokerException, InterruptedException, MQClientException {
   ...
   * @throws MQBrokerException    消息队列Broker异常
  ...
  public SendResult sendMessage(
    ...
    // 调用重载的sendMessage方法，传入null参数以保持一致性
  ...
  public void popMessageAsync(
      final String brokerName, final String addr,
  ...
  private PopResult processPopResponse(final String brokerName,
      final RemotingCommand response, String topic,
   ...
   */
  private static Map<String, List<Long>> buildQueueOffsetSortedMap(String topic,
  ...
  public MessageExt viewMessage(final String addr, final String topic,
      final long phyoffset, final long timeoutMillis)
      throws RemotingException, MQBrokerException, InterruptedException {
  ...
  @Deprecated
  public long searchOffset(final String addr, final String topic,
      final int queueId, final long timestamp,
      final long timeoutMillis)
      throws RemotingException, MQBrokerException, InterruptedException {
  ...
  public long searchOffset(final String addr, final MessageQueue messageQueue,
  ...
  public long getMaxOffset(final String addr, final MessageQueue messageQueue,
      final long timeoutMillis)
      throws RemotingException, MQBrokerException, InterruptedException {
  ...
  public long getMinOffset(final String addr, final MessageQueue messageQueue,
      final long timeoutMillis)
      throws RemotingException, MQBrokerException, InterruptedException {
  ...
  public boolean registerClient(final String addr,
      final HeartbeatData heartbeat, final long timeoutMillis)
      throws RemotingException, InterruptedException {
    RemotingCommand request = RemotingCommand.createRequestCommand(RequestCode.HEART_BEAT, new HeartbeatRequestHeader());
  ...
  public TopicStatsTable getTopicStatsInfo(final String addr,
      final String topic,
  ...
  public ProducerTableInfo getAllProducerInfo(final String addr,
      final long timeoutMillis)
      throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException,
      MQBrokerException {
  ...
  public KVTable getBrokerRuntimeInfo(final String addr,
  ...
  public void addBroker(final String addr, final String brokerConfigPath,
      final long timeoutMillis)
  ...
  public void removeBroker(final String addr, String clusterName,
  ...
  public void updateBrokerConfig(final String addr, final Properties properties,
      final long timeoutMillis)
      throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException,
  ...
  public void updateColdDataFlowCtrGroupConfig(final String addr,
      final Properties properties, final long timeoutMillis)
  ...
  public void removeColdDataFlowCtrGroupConfig(final String addr,
      final String consumerGroup, final long timeoutMillis)
      throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException, MQBrokerException, UnsupportedEncodingException {
  ...
  public String getColdDataFlowCtrInfo(final String addr,
      final long timeoutMillis)
      throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException, MQBrokerException, UnsupportedEncodingException {
  ...
  public String setCommitLogReadAheadMode(final String addr, final String mode,
      final long timeoutMillis)
  ...
  public TopicRouteData getDefaultTopicRouteInfoFromNameServer(
      final long timeoutMillis)
  ...
  public int addWritePermOfBroker(final String nameSrvAddr, String brokerName,
      final long timeoutMillis)
  ...
  public void deleteTopicInNameServer(final String addr,
      final String clusterName, final String topic,
      final long timeoutMillis)
      throws RemotingException, MQBrokerException, InterruptedException, MQClientException {
    DeleteTopicFromNamesrvRequestHeader requestHeader = new DeleteTopicFromNamesrvRequestHeader();
    requestHeader.setTopic(topic);
  ...
  public void deleteSubscriptionGroup(final String addr, final String groupName,
  ...
  public Map<MessageQueue, Long> invokeBrokerToResetOffset(final String addr,
  ...
  public Map<String, Map<MessageQueue, Long>> invokeBrokerToGetConsumerStatus(
      final String addr, final String topic,
      final String group,
  ...
  public GroupList queryTopicConsumeByWho(final String addr, final String topic,
      final long timeoutMillis)
      throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException,
      MQBrokerException {
  ...
  public TopicList queryTopicsByConsumer(final String addr, final String group,
      final long timeoutMillis)
      throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException,
      MQBrokerException {
  ...
  public SubscriptionData querySubscriptionByConsumer(final String addr,
  ...
  public List<QueueTimeSpan> queryConsumeTimeSpan(final String addr,
      final String topic, final String group,
      final long timeoutMillis)
      throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException,
      MQBrokerException {
  ...
  public TopicList getTopicsByCluster(final String cluster,
      final long timeoutMillis)
      throws RemotingException, MQClientException, InterruptedException {
  ...
  public TopicList getSystemTopicListFromBroker(final String addr,
      final long timeoutMillis)
      throws RemotingException, MQClientException, InterruptedException {
  ...
  public boolean deleteExpiredCommitLog(final String addr,
  ...
  public Map<Integer, Long> queryCorrectionOffset(final String addr,
      final String topic, final String group,
  ...
  public TopicList getUnitTopicList(final boolean containRetry,
      final long timeoutMillis)
      throws RemotingException, MQClientException, InterruptedException {
  ...
  public TopicList getHasUnitSubTopicList(final boolean containRetry,
      final long timeoutMillis)
      throws RemotingException, MQClientException, InterruptedException {
  ...
  public BrokerStatsData viewBrokerStatsData(String brokerAddr,
      String statsName, String statsKey, long timeoutMillis)
  ...
  public SubscriptionGroupWrapper getAllSubscriptionGroup(
  ...
  public SubscriptionGroupConfig getSubscriptionGroupConfig(
      final String brokerAddr, String group,
      long timeoutMillis) throws InterruptedException,
      RemotingTimeoutException, RemotingSendRequestException, RemotingConnectException, MQBrokerException {
  ...
  public void updateNameServerConfig(final Properties properties,
      final List<String> nameServers, long timeoutMillis)
  ...
  public QueryConsumeQueueResponseBody queryConsumeQueue(
      final String brokerAddr, final String topic,
      final int queueId,
  ...
  public CheckRocksdbCqWriteResult checkRocksdbCqWriteProgress(
      final String brokerAddr, final String topic, final long checkStoreTime,
      final long timeoutMillis) throws InterruptedException,
      RemotingTimeoutException, RemotingSendRequestException, RemotingConnectException, MQClientException {
  ...
  public void checkClientInBroker(final String brokerAddr,
      final String consumerGroup,
  ...
  public boolean resumeCheckHalfMessage(final String addr, String topic,
      String msgId,
  ...
  public void setMessageRequestMode(final String brokerAddr, final String topic,
      final String consumerGroup,
  ...
  public TopicConfigAndQueueMapping getTopicConfig(final String brokerAddr,
      String topic,
      long timeoutMillis) throws InterruptedException,
      RemotingTimeoutException, RemotingSendRequestException, RemotingConnectException, MQBrokerException {
  ...
  public void createStaticTopic(final String addr, final String defaultTopic,
      final TopicConfig topicConfig,
   ...
   */
  public GroupForbidden updateAndGetGroupForbidden(String addr,
      UpdateGroupForbiddenRequestHeader requestHeader,
  ...
  public void resetMasterFlushOffset(final String brokerAddr,
      final long masterFlushOffset)
      throws InterruptedException, RemotingTimeoutException, RemotingSendRequestException, RemotingConnectException, MQBrokerException {
  ...
  public HARuntimeInfo getBrokerHAStatus(final String brokerAddr,
      final long timeoutMillis)
  ...
  public Map<String, Properties> getControllerConfig(
      final List<String> controllerServers,
      final long timeoutMillis) throws InterruptedException, RemotingTimeoutException,
  ...
  public void updateControllerConfig(final Properties properties,
  ...
  public Pair<ElectMasterResponseHeader, BrokerMemberGroup> electMaster(
      String controllerAddr, String clusterName,
      String brokerName,
  ...
  public void cleanControllerBrokerData(String controllerAddr,
      String clusterName,
      String brokerName, String brokerControllerIdsToClean,
  ...
  public void createUser(String addr, UserInfo userInfo,
      long millis) throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException, MQBrokerException {
  ...
  public void updateUser(String addr, UserInfo userInfo,
      long millis) throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException, MQBrokerException {
  ...
  public void deleteUser(String addr, String username,
      long millis) throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException, MQBrokerException {
  ...
  public UserInfo getUser(String addr, String username,
      long millis) throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException, MQBrokerException {
  ...
  public List<UserInfo> listUser(String addr, String filter,
      long millis) throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException, MQBrokerException {
  ...
  public void createAcl(String addr, AclInfo aclInfo,
      long millis) throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException, MQBrokerException {
  ...
  public void updateAcl(String addr, AclInfo aclInfo,
      long millis) throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException, MQBrokerException {
  ...
  public AclInfo getAcl(String addr, String subject,
      long millis) throws RemotingConnectException, RemotingSendRequestException, RemotingTimeoutException, InterruptedException, MQBrokerException {
  ...
  public List<AclInfo> listAcl(String addr, String subjectFilter,
