...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
  ...
  public void setPullThresholdSizeForQueue(
      final int pullThresholdSizeForQueue) {
  ...
  public void setPullThresholdSizeForTopic(
      final int pullThresholdSizeForTopic) {
  ...
  /**
   * 此方法用于准备内部基础设施以提供服务。实例必须在配置完成后调用此方法。
   *
  ...
  public void start() throws MQClientException {
    ...
    // 启动内部的 DefaultMQPushConsumerImpl 实例
    ...
    if (enableTrace) {
      try {
        ...
        // 记录错误日志，说明系统 MQ 跟踪钩子初始化失败，可能无法发送消息跟踪数据
        log.error("系统 MQ 跟踪钩子初始化失败，可能无法发送消息跟踪数据", e);
      }
    }
  ...
  public void setSuspendCurrentQueueTimeMillis(
  ...
  public void setAwaitTerminationMillisWhenShutdown(
      long awaitTerminationMillisWhenShutdown) {
  ...
  public void setMessageQueueListener(
